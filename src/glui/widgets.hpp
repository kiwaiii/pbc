...
namespace glui
{
    ...
    public:
		...
		//---------------------------------------------------------------------
        void Mouse(int _x, int _y, Mouse::Button _button, Mouse::State _state, int _modifier);

		//---------------------------------------------------------------------
        // UI method for processing mouse events
		//---------------------------------------------------------------------
        void Mouse(int _x, int _y, Mouse::Button _button, Mouse::State _state);
		...
		//---------------------------------------------------------------------		
		virtual void Initialize(int _w, int _h);
