...
namespace glui
{
	...
	//--------------------------------------------------------------------------
	void UIContext::Mouse(int _x, int _y, Mouse::Button _button, Mouse::State _state, int _modifier)
	{
		setCursor(_x, _y);
	...
	//--------------------------------------------------------------------------
    void UIContext::Mouse(int _x, int _y, Mouse::Button _button, Mouse::State _state)
	{ 
		Mouse(_x, _y, _button, _state, 0);
	}
	//--------------------------------------------------------------------------
...
//TODO place after BeginFrame ?
	...
	//--------------------------------------------------------------------------
	void UIContext::Initialize(int _w, int _h)
	{
